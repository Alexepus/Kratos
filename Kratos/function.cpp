...
// —просить пользовател€ о необходимости сохранить незаконченный скан и сохранить в файл, если надо
...
{ //NewData - массив точек в недосн€том скане, NNewData - число точек
	...
	else
	{
		...
		pMainFrame->m_Doc.XpsProject.SaveDataInToFile(pMainFrame->m_Doc.m_ThrComm.pRegNow);
	}
	//else //if(YesNo == IDNO)
...
// –ассчитывает оставшеес€ врем€ в мс, необходимое дл€ прохода недосн€тых регионов XPS
