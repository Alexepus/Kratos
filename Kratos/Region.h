...
doubleTime LastEditTime = 0; //Время последнего изменения параметров региона
};
...
doubleTime m_BeginTime; // Время начала сканирования региона
doubleTime m_EndTime; // Время окончания сканирования региона
