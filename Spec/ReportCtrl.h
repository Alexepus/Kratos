...
public:
	...
	CArray<BOOL, BOOL> aAllowEdit; // Sub item edit permition
};
...
public:		
	...
	BOOL IsEditable(int Row, int Column) const; // Is Item text editable?
	void SetEditable(BOOL bSet, int Row=-1, int Column=-1); // Allow item text editting
	...
	bool IsUnderEdit(){return m_bUnderEdit;}
...
protected:	
	...
	//typedef std::vector<BOOL> t_vector;
	//std::vector<t_vector> m_bvAllowEdit;
	...
	CArray<BOOL, BOOL> aAllowEditForNewItems; // Column edit permition for new items
	//////////////////////////////////////////////////////////////////////
