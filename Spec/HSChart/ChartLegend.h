...
//	int SerieIndexFromPoint(CPoint NewPoint) const;
	...
	void SetSampleWidth(int Width){m_iSampleWidth=Width;};
	int GetSampleWidth(){return m_iSampleWidth;};
	void SetFrameVisible(bool Visible=true){m_bIsFrameVisible=Visible;}
	bool GetFrameVisible(){return m_bIsFrameVisible;}
	void SetAutoPosition(bool Auto=true){m_bAutoPosition=Auto;}
	bool GetAutoPosition(){return m_bAutoPosition;}
	void SetUserPosition(CPoint TopLeft){m_ObjectRect.TopLeft()=TopLeft;}
	CPoint GetUserPosition(){CPoint TopLeft=m_ObjectRect.TopLeft(); return TopLeft;}
