...
void CChartSerie::AddPoint(double X, double Y)
{
	...
	pDC = m_pParent->GetScreenDC();
	Draw(pDC);
	m_pParent->ReleaseScreenDC(pDC);
}
...
void CChartSerie::SetPoints(vector<SChartPoint> Points)
{
	m_vPoints=Points;
	m_pHorizontalAxis->RefreshAutoAxis();
	m_pVerticalAxis->RefreshAutoAxis();
...
void CChartSerie::GetPoints(double *X, double *Y)
{
...
vector<CChartSerie::SChartPoint> CChartSerie::GetPoints()
{
	return m_vPoints;
}
...
CChartLinePointsSerie* CChartSerie::GetAsLinePoints()
{
	ASSERT(m_iSerieType==stLinePointsSerie);
	return reinterpret_cast<CChartLinePointsSerie*>(this);
}

CChartTrapeziumSerie* CChartSerie::GetAsTrapezium()
{
	ASSERT(m_iSerieType==stTrapeziumSerie);
	return reinterpret_cast<CChartTrapeziumSerie*>(this);
}

COLORREF CChartSerie::GetBackColor() const
{
	return m_pParent->BackColor;
}
