...
public:
	...
	CChartLinePointsSerie* GetAsLinePoints();
	CChartTrapeziumSerie* GetAsTrapezium();

	void AddPoint(double X, double Y);
	void AddPoints(double *X, double *Y, int Count);
	void SetPoints(double *X, double *Y, int Count);
	void SetPoints(vector<SChartPoint> Points);
	void GetPoints(double *X, double *Y);
	vector<SChartPoint> GetPoints();
