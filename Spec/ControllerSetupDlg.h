#if !defined(AFX_CONTROLLERSETUPDLG_H__1CF26151_115E_4841_984D_CF2270CB8D56__INCLUDED_)
#define AFX_CONTROLLERSETUPDLG_H__1CF26151_115E_4841_984D_CF2270CB8D56__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// ControllerSetupDlg.h : header file
//
#include "resource.h"
...
class CControllerSetupDlg : public CDialog
{
// Construction
public:
	bool m_bExist;
	...
	void SavePidParam();
	void SavePidCoefs();
	CControllerSetupDlg(CWnd* pParent = NULL);   // standard constructor
	LRESULT OnComEvent(WPARAM WParam, LPARAM LParam);

// Dialog Data
	//{{AFX_DATA(CControllerSetupDlg)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CControllerSetupDlg)
	protected:
...
#endif // !defined(AFX_CONTROLLERSETUPDLG_H__1CF26151_115E_4841_984D_CF2270CB8D56__INCLUDED_)
