...
if((GetFileSize(hFile,NULL)>MaxSize) && (MaxSize>0)) //Если размер файла >MaxSize, удаляем первые строки до MaxSize*0.95
{
...
//Добавляет строку сообщения об ошибке в log файл программы "Spec.log",
...
//Добавляет строку сообщения о текущем файле и строке в log файл программы "Spec.log",
//сопровождая сообщение датой и временем
...
//Добавляет строку сообщения в log файл программы "Spec.log",
//сопровождая сообщение датой и временем
...
//Добавляет строку сообщения в указанный файл,
//сопровождая сообщение датой и временем
